...
public class Datve_Second_Floor_Fragment extends Fragment {
    ...
    private void chongheA1T(final ImageView imageView){
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Check_A1T == true) {
                    if (Datve_First_Floor_Fragment.listGheDaChonTang1.size()<2) {
                        imageView.setImageResource(R.drawable.ghedangchon1);
                        Datve_First_Floor_Fragment.listGheDaChonTang1.add(imageView.getTag().toString());
                    ...
                    Datve_First_Floor_Fragment.listGheDaChonTang1.remove(Datve_First_Floor_Fragment.listGheDaChonTang1.size() - 1);
