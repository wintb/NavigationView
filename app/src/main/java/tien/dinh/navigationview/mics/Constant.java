package tien.dinh.navigationview.mics;
...
public class Constant {
    ...
    public static final String URL_TAIXE = "http://10.0.3.2:8080/xekhach/json_tai_xe.php";
    public static final String URL_SODOGHE = "http://10.0.3.2:8080/xekhach/Json_so_do_ghe.php";
